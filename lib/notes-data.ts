import { generateId, daysFromNow, formatRelativeTime } from "./study-plan-data"
...
export const NOTES: Note[] = [
  {
    ...
    updatedAt: daysFromNow(-5), // 5 days ago
    rating: 4.5,
    ratingCount: 10,
    viewCount: 150,
    likeCount: 25,
  ...
  },
  {
    ...
    updatedAt: daysFromNow(-2), // 2 days ago
    rating: 4.8,
    ratingCount: 15,
    viewCount: 210,
    likeCount: 45,
  ...
  },
  {
    ...
    updatedAt: daysFromNow(-3), // 3 days ago
    rating: 4.0,
    ratingCount: 6,
    viewCount: 78,
    likeCount: 18,
